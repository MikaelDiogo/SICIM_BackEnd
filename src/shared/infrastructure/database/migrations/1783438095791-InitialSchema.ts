...
export class InitialSchema1783438095791 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."audit_logs_action_enum" AS ENUM('CREATE', 'UPDATE', 'DELETE', 'APPROVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."managing_units_type_enum" AS ENUM('SECRETARIAT', 'AUTARCHY', 'FOUNDATION')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."properties_usagecategory_enum" AS ENUM('ADMINISTRATIVE', 'EDUCATIONAL', 'HEALTH', 'SOCIAL_ASSISTANCE', 'CULTURAL', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."properties_possessiontype_enum" AS ENUM('OWNED', 'RENTED', 'GRANTED', 'LOAN', 'USUFRUCT', 'USE_PERMIT')`);
        await queryRunner.query(`CREATE TYPE "public"."properties_status_enum" AS ENUM('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'INACTIVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('REGISTRATION', 'VIEWER', 'APPROVAL', 'ADMINISTRATION')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."properties_possessiontype_enum"`);
        await queryRunner.query(`DROP TYPE "public"."properties_usagecategory_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."managing_units_type_enum"`);
